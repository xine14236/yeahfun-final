...
export default function BlogCategoryModal({visible=false,handleOk,handleCancel,initialCate=[],category=[],setCategory=()=>{}, toggleCheckbox=()=>{}, handleCategoryCheckedAll=()=>{},}) {
...
onChange={(e)=>{handleCategoryCheckedAll(e.target.checked,1)}}
   />
   全選
 </label>
 <br />
 ...
 <hr />
      ...
      onChange={(e)=>{handleCategoryCheckedAll(e.target.checked,2)}}
          />
          全選
        </label>
        <br />
      ...
      onChange={(e)=>{handleCategoryCheckedAll(e.target.checked,3)}}
          />
          全選
        </label>
        <br />
...
onChange={(e)=>{handleCategoryCheckedAll(e.target.checked,5)}}
   />
   全選
 </label>
 <br />
...
onChange={(e)=>{handleCategoryCheckedAll(e.target.checked,4)}}
   />
   全選
 </label>
 <br />
