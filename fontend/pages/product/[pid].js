    ...
    <>
      <>
        ...
        <div className="pagecontent container mt-4">
          <div className="campTitle" style={{ border: '1px solid red' }}>
            <h1>青山綠水露營地</h1>
          ...
          <div className="campIntroduce" style={{ border: '1px solid red' }}>
            <div className="briefIntroduce">
              <p>
                露悠悠
                iti）布農語在這裡休息。海拔900公尺環境優雅清靜，群山環繞鳥語草香，遠眺玉山、郡大山、望鄉山，舉目所見盡是超寬角的山野景觀。除了提供露營場地、民宿及信義鄉旅遊諮詢，還可在此進行烤肉、營火晚會、體驗布農相關文化等活動，不論是家族出遊，同學會或戶外研習活動甚至想偷一點清靜閒適的朋友們都相當適合
              </p>
            </div>
...
<div class="carousel-inner">
  ...
  <div class="carousel-item">
    <img src="https://via.placeholder.com/800x400?text=露營景色2" class="d-block w-100" alt="露營景色2">
          ...
          <div
            className="campDescription row mb-4"
